...
>
  <head>
    ...
    <title>Đơn đặt hàng số {{$order_id}}</title>
    <style type="text/css">
      #outlook a {
        padding: 0;
      }
                                        ...
                                        <tbody>
                                          <tr style="border-collapse: collapse;">
                                            <td class="es-m-p0l es-m-txt-c" align="left" style="padding: 0; margin: 0; padding-left: 15px; font-size: 0;">
                                              ...
                                              >
                                                <img
                                                  src="{{isset($configuration['logo'])?url($configuration['logo']):''}}"
                                          ...
                                          <tr style="border-collapse: collapse;">
                                            <td align="center" style="padding: 0; margin: 0; padding-top: 10px; padding-bottom: 15px;">
                                              <h1
                                                ...
                                                "
                                              >
                                               Thông tin đơn hàng số {{$order_id}}<br />
                                              </h1>
                                            </td>
                                          </tr>
                                          <tr style="border-collapse: collapse;">
                                            <td align="center" style="margin: 0; padding-top: 5px; padding-bottom: 5px; padding-left: 40px; padding-right: 40px;">
                                              <p
                                                ...
                                                "
                                              >
                                              Tuyệt vời, {{env('APP_NAME')}} đã nhận được khoản thanh toán cho đơn hàng mã #{{$order_id}} và đã thông báo để Người bán nhanh chóng chuyển hàng cho bạn.
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                          <tr style="border-collapse: collapse;">
                                            <td align="left" style="margin: 0; padding-bottom: 10px; padding-top: 20px; padding-left: 20px; padding-right: 20px;">
                                              <h4 style="margin: 0; line-height: 120%; mso-line-height-rule: exactly; font-family: 'trebuchet ms', helvetica, sans-serif;">Chi tiết:</h4>
                                            </td>
                                          </tr>
                                          <tr style="border-collapse: collapse;">
                                              ...
                                              >
                                                <tbody>
                                                  ...
                                                  <tr style="border-collapse: collapse;">
                                                    ...
                                                    <td style="padding: 0; margin: 0;"><span style="font-size: 14px; line-height: 21px;">{{$method}}</span></td>
                                                  </tr>
                                                  <tr style="border-collapse: collapse;">
                                    ...
                                    <tr style="border-collapse: collapse;">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px;">
                                            ...
                                            <tr style="border-collapse: collapse;">
                                                ...
                                                <h4 style="margin: 0; line-height: 120%; mso-line-height-rule: exactly; font-family: 'trebuchet ms', helvetica, sans-serif;">Sản phẩm</h4>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tr style="border-collapse: collapse;">
                                                ...
                                                <table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0">
                                                    ...
                                                    <tr style="border-collapse: collapse;">
                                                        ...
                                                        <span style="font-size: 13px;"><span style="line-height: 100%;">Số lượng</span></span>
                                                        </td>
                                                        <td style="padding: 0; margin: 0; width: 100px; text-align: center;">
                                                        <span style="font-size: 13px;"><span style="line-height: 100%;">Đơn giá</span></span>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <tr style="border-collapse: collapse;">
                                                    ...
                                                    <table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; width: 100%;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0">
                                                        ...
                                                        <tr style="border-collapse: collapse;">
                                                            ...
                                                            <td style="padding: 0; margin: 0; width: 100px; text-align: center;"> {{number_format($item['qty']*$item['price'],0,".",",")}}đ</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    <p
                                              ...
                                              >
                                                <tbody>
                                                  ...
                                                  <tr style="border-collapse: collapse;">
                                                    ...
                                                    <td style="padding: 0; margin: 0; text-align: right; font-size: 18px; line-height: 27px; color: #d48344;"><strong>{{number_format($subTotal + $ship,0,'.',',')}}đ</strong></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                              <p
