        ...
        <fieldset id="payment-address">
            <div id="payment-new" class="row" style="display: block;">
                <div class="form-group col-sm-12 required">
                    ...
                    <input type="text" name="payment_   firstname" value="" placeholder="Họ và tên:" id="input-payment-firstname" class="form-control" required="" autocomplete="billing given-name">
                </div>
        ...
        <fieldset id="shipping-address">
            <div id="shipping-new" style="display: block;">
                <div class="form-group col-sm-12 required">
                    ...
                    <input type="text" name="shipping_firstname" value="tranduyhoa" placeholder="Họ và tên:" id="input-shipping-firstname" class="form-control" required="" autocomplete="shipping given-name">
                </div>
