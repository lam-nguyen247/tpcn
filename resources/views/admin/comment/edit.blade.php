...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{route('comment.update', $comment->id)}}" class="floating-labels mt-4" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-sm-12 col-md-8 col-xl-9 d-flex align-items-center mb-2">
                                <div class="card card-body px-0 mb-0">
                                    <div class="form-group focused @error('name') has-error @enderror">
                                        <input id="name" value="{{$comment->name}}" type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" required>
                                        <span class="bar"></span>
                            ...
                            <div class="col-sm-12 col-md-8 col-xl-9 d-flex align-items-center mb-2">
                                <div class="card card-body px-0 mb-0">
                                    ...
                                    <div class="form-group focused @error('content') has-error @enderror">
                                        <textarea required name="content" id="content" class="form-control" rows="5">{!!$comment->content!!}</textarea>
                                        @error('content')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-12 col-md-8 col-xl-9 d-flex align-items-center mb-2">
                                <div class="card card-body px-0 mb-0">
                                    ...
                                    <div class="form-group focused @error('reply') has-error @enderror">
                                        <textarea name="reply" id="reply" class="form-control"  rows="5">{!!$comment->reply!!}</textarea>
                                        @error('reply')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
